...
if ! sha256sum breeze-snow.zip | grep -q '1390272e693f258dc55f86fbd5c99f0f36cfb4e71f22e9062b8d6ff14483562e'; then
...
stdbuf -o0 /bin/echo -n 'Setting up theme defaults... ';
/bin/echo -e '[Icon Theme]\nInherits=breeze-snow' > /usr/share/icons/default/index.theme;
/bin/echo 'done.';

stdbuf -o0 /bin/echo -n 'Downloading Papirus icon theme... ';
...
stdbuf -o0 /bin/echo -n 'Installing Papirus icon theme... ';
...
cd "$cwd" || exit 127;
stdbuf -o0 /bin/echo -n 'Configuring wallpaper defaults... ';
...
stdbuf -o0 /bin/echo -n 'Configuring GTK+ defaults... ';
