...
stdbuf -o0 /bin/echo -n 'Downloading SkeuOS GTK+ theme... ';
curl -fsSL 'https://github.com/daniruiz/skeuos-gtk/archive/refs/tags/20220629.tar.gz' > skeuos.tar.gz;
/bin/echo 'done.';

stdbuf -o0 /bin/echo -n 'Installing SkeuOS GTK+ theme... ';
...
stdbuf -o0 /bin/echo -n 'Extracting Fumaca 2.0 Openbox theme... ';
mkdir -p /usr/share/themes;
cwd="$PWD";
